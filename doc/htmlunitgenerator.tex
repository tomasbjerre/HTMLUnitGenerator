...
%several containing
Boolean logics, \textit{and}/\textit{or}, can be used to accept different combinations of containing strings. Listing \ref{findstringandor} shows how the string \textit{Hello World} is asserted to be found along with \textit{Alternative1} or \textit{Alternative2}.
