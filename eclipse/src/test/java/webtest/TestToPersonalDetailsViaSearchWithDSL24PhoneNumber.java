...
Find input with attribute name set to address.street in Website or wait at most 10 seconds
Find input with attribute name set to _checkboxIHaveNoPhoneLine in Website
...
Find select with attribute name set to address.floor in Website or wait at most 20 seconds
Fill in locationForm with address.floor as option number 1

Click on _eventId_search
Find input with attribute value set to tcm:142-23267 in Website or wait at most 10 seconds
Click on OrderCartCheckoutOrder
Find input with attribute id set to firstName in Website or wait at most 10 seconds
*/

@SuppressWarnings("unchecked")
public class TestToPersonalDetailsViaSearchWithDSL24PhoneNumber extends TestCase {
...
Find input with attribute name set to address.street in Website or wait at most 10 seconds
*/
findOrFail("/html/body", "input", "name", "address.street", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 10000);
/**
Find input with attribute name set to _checkboxIHaveNoPhoneLine in Website
*/
findOrFail("/html/body", "input", "name", "_checkboxIHaveNoPhoneLine", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 0);
/**
Path SearchFlowUseAddress is //*[@id="checkboxIHaveNoPhoneLine"]
Click on SearchFlowUseAddress
*/
...
Find select with attribute name set to address.floor in Website or wait at most 20 seconds
*/
findOrFail("/html/body", "select", "name", "address.floor", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 20000);
/**
Fill in locationForm with address.floor as option number 1
...
Find input with attribute value set to tcm:142-23267 in Website or wait at most 10 seconds
*/
findOrFail("/html/body", "input", "value", "tcm:142-23267", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 10000);
/**
Path OrderCartCheckoutOrder is //*[@id="orderButton"]
Click on OrderCartCheckoutOrder
*/
...
Find input with attribute id set to firstName in Website or wait at most 10 seconds
*/
findOrFail("/html/body", "input", "id", "firstName", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 10000);
