...
Fill in locationForm with _eventId as search and phoneNumber.fullNumber as 0842007183

Click on _eventId_search
Find a with attribute href set to /orderflow/index.html?Id=tcm:142-32724&fromSearch&page=new in Website or wait at most 200 seconds
Click on SearchFlowChooseFoundOffer
Find input with attribute value set to tcm:142-32717 in Website or wait at most 200 seconds
Click on OrderCartCheckoutOrder
Find input with attribute id set to firstName in Website or wait at most 200 seconds
*/

@SuppressWarnings("unchecked")
public class TestToPersonalDetailsViaSearchResultWithLAN1000UsingAddress extends TestCase {
...
Find input with attribute name set to phoneNumber.fullNumber in Website or wait at most 200 seconds
*/
findOrFail("/html/body", "input", "name", "phoneNumber.fullNumber", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 200000);
/**
Fill in locationForm with _eventId as search and phoneNumber.fullNumber as 0842007183
...
setAttributeValue(form, "phoneNumber.fullNumber", "0842007183");
...
Find a with attribute href set to /orderflow/index.html?Id=tcm:142-32724&fromSearch&page=new in Website or wait at most 200 seconds
*/
findOrFail("/html/body", "a", "href", "/orderflow/index.html?Id=tcm:142-32724&fromSearch&page=new", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 200000);
/**
Path SearchFlowChooseFoundOffer is /html/body/div[8]/div/div[9]/form[2]/div[2]/div[1]/div/div[2]/a[1]
Click on SearchFlowChooseFoundOffer
*/
...
Find input with attribute value set to tcm:142-32717 in Website or wait at most 200 seconds
*/
findOrFail("/html/body", "input", "value", "tcm:142-32717", "http://www.bredbandsbolaget.se/bredband/hastighet/bredband24/index.html", 200000);
/**
Path OrderCartCheckoutOrder is //*[@id="orderButton"]
Click on OrderCartCheckoutOrder
*/
