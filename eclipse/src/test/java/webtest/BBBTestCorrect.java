...
Find input with attribute value set to tcm:142-23267 in website
*/
findOrFail("/html/body", "input", "value", "tcm:142-23267", "http://www.bredbandsbolaget.se/bredband/bredband1000/index.html");
/**
Path checkoutOrder is //*[@id="orderButton"]
Click on checkoutOrder and wait 10 seconds
*/
...
Find input with attribute src set to /res/img/button/tillbaka.png in website
*/
findOrFail("/html/body", "input", "src", "/res/img/button/tillbaka.png", "http://www.bredbandsbolaget.se/bredband/bredband1000/index.html");
