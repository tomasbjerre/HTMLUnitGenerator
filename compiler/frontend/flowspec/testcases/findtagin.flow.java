...
Path mypopup is //*[@id="mypopup"]

Url myUrl is http://www.my.domain/page.html

Go to myUrl
Find a with attribute href set to /link/category/mix in mypopup
*/

@SuppressWarnings("unchecked")
public class findtagin extends TestCase {
...
if (!((findOneMathingElement(getElementsByTagName("//*[@id=\"mypopup\"]", "a"),new String[]{"href"},new String[]{"/link/category/mix"}) != null
))) {
successfull = false;
}
