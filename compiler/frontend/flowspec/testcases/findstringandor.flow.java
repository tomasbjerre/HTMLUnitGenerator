...
Go to myUrl
Find containing "Hello World" and containing Alternative1 or containing "Hello World" and containing Alternative2
*/

@SuppressWarnings("unchecked")
public class findstringandor extends TestCase {
...
if (!(find("/html/body", "Hello World")
 && find("/html/body", "Alternative1")
 || find("/html/body", "Hello World")
