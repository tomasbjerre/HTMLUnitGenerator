...
Url myUrl is http://www.my.domain/page.html

Go to myUrl
Find a with attribute href set to /link/category/mix and h2 with attribute class set to alternative1 or a with attribute href set to /link/category/mix and h2 with attribute class set to alternative2
*/

@SuppressWarnings("unchecked")
public class findtagandor extends TestCase {
...
Go to myUrl
*/
page = webClient.getPage("http://www.my.domain/page.html");
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/mix"}) != null
) && (findOneMathingElement(getElementsByTagName("/html/body", "h2"),new String[]{"class"},new String[]{"alternative1"}) != null
) || (findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/mix"}) != null
) && (findOneMathingElement(getElementsByTagName("/html/body", "h2"),new String[]{"class"},new String[]{"alternative2"}) != null
))) {
successfull = false;
}
