...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"something"}) != null
) && (findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"someid"}) != null
))) {
successfull = false;
}
