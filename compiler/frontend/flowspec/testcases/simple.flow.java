...
Url SomeSite is http://www.somesite.domain/

Go to SomeSite
Find a with attribute href set to /some/target
*/
...
Go to SomeSite
*/
page = webClient.getPage("http://www.somesite.domain/");
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/some/target"}) != null
))) {
successfull = false;
}
