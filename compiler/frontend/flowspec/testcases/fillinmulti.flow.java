...
Go to SomeUrl
Fill in userForm with name as Tomas Bjerre and gender as male

Click on choose
*/

@SuppressWarnings("unchecked")
public class fillinmulti extends TestCase {
...
*/
form = getFormById("userForm");
setAttributeValue(form, "name", "Tomas Bjerre");
setAttributeValue(form, "gender", "male");
