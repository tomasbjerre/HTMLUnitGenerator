...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href","id"},new String[]{"/link/category/blandat","somethingelse"}) != null
))) {
successfull = false;
}
...
boolean successfull = true;
webClient.waitForBackgroundJavaScriptStartingBefore(100);
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href","id"},new String[]{"/link/category/blandat","something else"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/blandat"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"somethingelse"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
...
webClient.waitForBackgroundJavaScriptStartingBefore(100);
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/blandat"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"something else"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/blandat"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"somethingelse"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"somethingelse2"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/blandat"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"something else"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"something else 2"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/blandat"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"somethingelse"}) != null
 && findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id2"},new String[]{"somethingelse2"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/blandat"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id"},new String[]{"something else"}) != null
 && findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"id2"},new String[]{"something else 2"}) != null
))) {
successfull = false;
}
} while (!successfull && (endTime-System.currentTimeMillis()) > 0);
