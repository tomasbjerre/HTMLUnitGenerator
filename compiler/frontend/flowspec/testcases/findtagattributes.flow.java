...
Go to myUrl
Find a with attribute href set to /link/category/mix or attribute a set to /link/category/other and attribute class set to otherClass
*/

@SuppressWarnings("unchecked")
public class findtagattributes extends TestCase {
...
if (!((findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"href"},new String[]{"/link/category/mix"}) != null
 || findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"a"},new String[]{"/link/category/other"}) != null
 && findOneMathingElement(getElementsByTagName("/html/body", "a"),new String[]{"class"},new String[]{"otherClass"}) != null
))) {
successfull = false;
}
