...
public class HTMLJunitGenerator extends Generator {
    ...
    private String methodFind = "private boolean find(HtmlPage page, String xpath, String tag, String attribute, String value) {\n"
    ...
    private String methodFindRecursive = "private boolean recursiveFind(DomNodeList<DomNode> nodeList, String tag,\n"
    ...
    private String methodFindText = "private boolean find(HtmlPage page, String xpath, String text) {\n"
            + " ArrayList<HtmlElement> matchingDivs;\n"
            + " boolean successfull;\n"
            + " matchingDivs = (ArrayList<HtmlElement>) page.getByXPath(xpath);\n"
            + " successfull = false;\n"
    ...
    private String methodFindById = "private HtmlForm getFormById(HtmlPage page, String id) {\n"
    ...
    public String toString() {
        ...
        result += " WebClient webClient = new WebClient();\n";
